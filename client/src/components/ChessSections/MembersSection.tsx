...
export default function MembersSection() {
  ...
  return (
    <section id="members" className="py-20 md:py-32 relative bg-transparent">
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 bg-transparent">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold font-display mb-4 bg-transparent">Meet Our Champions</h2>
          ...
          {isLoading ? (
            Array(4).fill(null).map((_, i) => (
              <div key={i} className="glass rounded-xl p-6 text-center animate-pulse">
                ...
                <div className="h-4 bg-gray-300 dark:bg-gray-700 rounded w-1/2 mx-auto mb-3"></div>
                <div className="h-4 bg-gray-300 dark:bg-gray-700 rounded w-1/3 mx-auto mb-4"></div>
